...
cred = credentials.Cert('cred.json')

firebase_admin.initialize_app(cred, {
    'databaseURL' : 'https://nlp-sahayam.firebaseio.com'
})
...
def example():
	...
	# return str(num_dogs) + " " + str(num_cats)
